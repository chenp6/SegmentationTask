"""
Top-level segmentation model: SAM3 backbone + adapters + decoder.
...
Usage:
    model = SAM3SegModel.build(num_classes=27, decoder_type="query")
...
from .sam3_backbone import SAM3Backbone
from .adapters import MultiStageAdapters


class SAM3SegModel(nn.Module):
    """SAM3 backbone + optional adapters + decoder."""
